    ...
    return (function (n) {
        ...
        e.exports = function (e) {
            return e.reduce((function (e, t) {
                var n, i, r, o, s;
                for (r in t) if (n = e[r], i = t[r], n && a.test(r)) if ("class" === r && ("string" == typeof n && (s = n, e[r] = n = {}, n[s] = !0), "string" == typeof i && (s = i, t[r] = i = {}, i[s] = !0)), "on" === r || "nativeOn" === r || "hook" === r) for (o in i) n[o] = l(n[o], i[o]); else if (Array.isArray(n)) e[r] = n.concat(i); else if (Array.isArray(i)) e[r] = [n].concat(i); else for (o in i) n[o] = i[o]; else e[r] = t[r];
                return e
            }), {})
        }
    }), (function (e, t, n) {
        var i = n(22), r = n(23), o = n(24);
        e.exports = function (e) {
            return i(e) || r(e) || o()
        }
    }), (function (e, t) {
        ...
        var y = n(6), S = n(25), b = n(8), O = Math.max, _ = Math.min;
        e.exports = function (i, r, e) {
            var o, s, a, l, u, c, d = 0, h = !1, f = !1, t = !0;
            ...
            function m() {
                var e, t, n = S();
                if (v(n)) return g(n);
                u = setTimeout(m, (t = r - ((e = n) - c), f ? _(t, a - (e - d)) : t))
            }
            ...
            function n() {
                ...
                if (o = arguments, s = this, c = t, n) {
                    if (void 0 === u) return d = e = c, u = setTimeout(m, r), h ? p(e) : l;
                    if (f) return u = setTimeout(m, r), p(c)
                }
                return void 0 === u && (u = setTimeout(m, r)), l
            }

            return r = b(r) || 0, y(e) && (h = !!e.leading, a = (f = "maxWait" in e) ? O(b(e.maxWait) || 0, r) : a, t = "trailing" in e ? !!e.trailing : t), n.cancel = function () {
        ...
        var i = n(26), r = "object" == typeof self && self && self.Object === Object && self,
            o = i || r || Function("return this")();
        e.exports = o
    }), (function (e, t, n) {
        var i = n(6), r = n(28), o = /^\s+|\s+$/g, s = /^[-+]0x[0-9a-f]+$/i, a = /^0b[01]+$/i, l = /^0o[0-7]+$/i,
            u = parseInt;
        e.exports = function (e) {
        ...
        var i = n(9), r = n(30), o = n(31), s = i ? i.toStringTag : void 0;
        e.exports = function (e) {
            return null == e ? void 0 === e ? "[object Undefined]" : "[object Null]" : s && s in Object(e) ? r(e) : o(e)
        }
    }), (function (e, t, n) {
        var i = n(9), r = Object.prototype, o = r.hasOwnProperty, s = r.toString, a = i ? i.toStringTag : void 0;
        e.exports = function (e) {
        ...
        "use strict";
        n.r(t);
        var i = n(15), N = n.n(i), r = n(0), E = n.n(r), o = n(3), s = n.n(o), a = n(1), w = n.n(a), l = n(16),
            u = n.n(l), c = n(4), L = n.n(c).a;
        ...
        var h, f = n(5), p = n.n(f), v = function (n, i) {
            var r = document.createElement("_"), o = r.appendChild(document.createElement("_")),
                s = r.appendChild(document.createElement("_")), e = o.appendChild(document.createElement("_")),
                a = void 0, l = void 0;
            return o.style.cssText = r.style.cssText = "height:100%;left:0;opacity:0;overflow:hidden;pointer-events:none;position:absolute;top:0;transition:0s;width:100%;z-index:-1", e.style.cssText = s.style.cssText = "display:block;height:100%;transition:0s;width:100%", e.style.width = e.style.height = "200%", n.appendChild(r), u(), function () {
                c(), n.removeChild(r)
            };
            ...
            function u() {
                ...
                e === a && t === l || (a = e, l = t, s.style.width = 2 * e + "px", s.style.height = 2 * t + "px", r.scrollLeft = r.scrollWidth, r.scrollTop = r.scrollHeight, o.scrollLeft = o.scrollWidth, o.scrollTop = o.scrollHeight, i({
                    width: e,
                    height: t
                })), o.addEventListener("scroll", u), r.addEventListener("scroll", u)
            }

            function c() {
                o.removeEventListener("scroll", u), r.removeEventListener("scroll", u)
            }
        };
        ...
        function S(e) {
            ...
            i === o && r === s || n({width: e.lastWidth = o, height: e.lastHeight = s})
        }

        function b(e, t) {
            var n = {$el: e, listener: t, lastWidth: null, lastHeight: null};
            return g.push(n), S(n), h = setInterval((function () {
                g.forEach(S)
            }), y), function () {
        ...
        function O(e, t) {
            var n = 9 === document.documentMode, i = !0, r = (n ? b : v)(e, (function () {
        ...
        function _(e, t) {
            var n = (function (e) {
                for (var t, n, i, r, o = [], s = e.parentNode; s && "BODY" !== s.nodeName && s.nodeType === document.ELEMENT_NODE;) t = getComputedStyle(s), n = t.overflow, i = t.overflowX, r = t.overflowY, /(auto|scroll|overlay)/.test(n + r + i) && o.push(s), s = s.parentNode;
                return o.push(window), o
            })(e);
            return window.addEventListener("resize", t, {passive: !0}), n.forEach((function (e) {
                e.addEventListener("scroll", t, {passive: !0})
            })), function () {
                window.removeEventListener("resize", t), n.forEach((function (e) {
        ...
        var x = n(10), M = n.n(x), I = n(11), D = n.n(I), T = n(12), $ = n.n(T), A = n(13), B = n.n(A),
            R = function () {
        ...
        var q = null, K = "ALL_CHILDREN", X = "ALL_DESCENDANTS", U = "LEAF_CHILDREN", Y = "LEAF_DESCENDANTS",
            J = "LOAD_ROOT_OPTIONS", G = "LOAD_CHILDREN_OPTIONS", Z = "ASYNC_SEARCH", ee = "BRANCH_PRIORITY",
            te = "LEAF_PRIORITY", ne = "ALL_WITH_INDETERMINATE", ie = "ORDER_SELECTED", re = 8, oe = 13, se = 27,
            ae = 35, le = 36, ue = 37, ce = 38, de = 39, he = 40, fe = 46;
        ...
        var ge = 0, ye = {
            ...
            props: {
                ...
                showCountOf: {
                    type: String, default: K, validator: function (e) {
                        return P([K, X, U, Y], e)
                    }
                },
                showCountOnSearch: null,
                sortValueBy: {
                    type: String, default: ie, validator: function (e) {
                ...
                value: null,
                valueConsistsOf: {
                    type: String, default: ee, validator: function (e) {
            ...
            computed: {
                selectedNodes: function () {
                    ...
                    var t, r = this;
                    if (this.single || this.flat || this.disableBranchNodes || "ALL" === this.valueConsistsOf) t = this.forest.selectedNodeIds.slice(); else if (this.valueConsistsOf === ee) t = this.forest.selectedNodeIds.filter((function (e) {
                        var t = r.getNode(e);
                        return !!t.isRootNode || !r.isSelected(t.parentNode)
                    })); else if (this.valueConsistsOf === te) t = this.forest.selectedNodeIds.filter((function (e) {
                        var t = r.getNode(e);
                        return !!t.isLeaf || 0 === t.children.length
                    })); else if (this.valueConsistsOf === ne) {
                        var e, n = [];
                        t = this.forest.selectedNodeIds.slice(), this.selectedNodes.forEach((function (e) {
                            e.ancestors.forEach((function (e) {
                                P(n, e.id) || P(t, e.id) || n.push(e.id)
                            }))
                        })), (e = t).push.apply(e, n)
                    }
                    return "LEVEL" === this.sortValueBy ? t.sort((function (e, t) {
                        return n = r.getNode(e), i = r.getNode(t), n.level === i.level ? pe(n, i) : n.level - i.level;
                        var n, i
                    })) : "INDEX" === this.sortValueBy && t.sort((function (e, t) {
                    ...
                    var t = this, n = [];
                    return this.traverseAllNodesByIndex((function (e) {
                        if (t.localSearch.active && !t.shouldOptionBeIncludedInSearchResult(e) || n.push(e.id), e.isBranch && !t.shouldExpand(e)) return !1
                    })), n
            ...
            methods: {
                verifyProps: function () {
                    ...
                    })), null != this.options || this.loadOptions || L((function () {
                        return !1
                    }), (function () {
                        return 'Are you meant to dynamically load options? You need to use "loadOptions" prop.'
                    })), this.flat && L((function () {
                        return t.multiple
                    }), (function () {
                        return 'You are using flat mode. But you forgot to add "multiple=true"?'
                    })), !this.flat) {
                        ["autoSelectAncestors", "autoSelectDescendants", "autoDeselectAncestors", "autoDeselectDescendants"].forEach((function (e) {
                            L((function () {
                                return !t[e]
                            }), (function () {
                    ...
                    if (Array.isArray(e)) {
                        ...
                        this.forest.nodeMap = R(), this.keepDataOfSelectedNodes(t), this.forest.normalizedOptions = this.normalize(q, e, t), this.fixSelectedNodeIds(this.internalValue)
                    ...
                    var t = this;
                    return null == this.value ? [] : "id" === this.valueFormat ? this.multiple ? this.value.slice() : [this.value] : (this.multiple ? this.value : [this.value]).map((function (e) {
                    ...
                    var n = this, e = {id: t};
                    return "id" === this.valueFormat ? e : W(this.multiple ? Array.isArray(this.value) ? this.value : [] : this.value ? [this.value] : [], (function (e) {
                        return e && n.enhancedNormalizer(e).id === t
                    })) || e
                }, fixSelectedNodeIds: function (e) {
                    var n = this, i = [];
                    if (this.single || this.flat || this.disableBranchNodes || "ALL" === this.valueConsistsOf) i = e; else if (this.valueConsistsOf === ee) e.forEach((function (e) {
                        i.push(e);
                        var t = n.getNode(e);
                        t.isBranch && n.traverseDescendantsBFS(t, (function (e) {
                            i.push(e.id)
                        }))
                    })); else if (this.valueConsistsOf === te) for (var t = R(), r = e.slice(); r.length;) {
                        var o = r.shift(), s = this.getNode(o);
                        i.push(o), s.isRootNode || (s.parentNode.id in t || (t[s.parentNode.id] = s.parentNode.children.length), 0 == --t[s.parentNode.id] && r.push(s.parentNode.id))
                    } else if (this.valueConsistsOf === ne) for (var a = R(), l = e.filter((function (e) {
                        var t = n.getNode(e);
                        return t.isLeaf || 0 === t.children.length
                    })); l.length;) {
                        var u = l.shift(), c = this.getNode(u);
                        i.push(u), c.isRootNode || (c.parentNode.id in a || (a[c.parentNode.id] = c.parentNode.children.length), 0 == --a[c.parentNode.id] && l.push(c.parentNode.id))
                    }
                    Q(this.forest.selectedNodeIds, i) && (this.forest.selectedNodeIds = i), this.buildForestState()
                    ...
                    var n = this, e = this.trigger.searchQuery, t = function () {
                        return n.resetHighlightedOptionWhenNecessary(!0)
                    };
                    if (!e) return this.localSearch.active = !1, t();
                    this.localSearch.active = !0, this.localSearch.noResults = !0, this.traverseAllNodesDFS((function (e) {
                        var t;
                        e.isBranch && (e.isExpandedOnSearch = !1, e.showAllChildrenOnSearch = !1, e.isMatched = !1, e.hasMatchedDescendants = !1, n.$set(n.localSearch.countMap, e.id, (t = {}, E()(t, K, 0), E()(t, X, 0), E()(t, U, 0), E()(t, Y, 0), t)))
                    }));
                    var i = e.trim().toLocaleLowerCase(), r = i.replace(/\s+/g, " ").split(" ");
                    this.traverseAllNodesDFS((function (t) {
                        n.searchNested && 1 < r.length ? t.isMatched = r.every((function (e) {
                        ...
                        })), t.isMatched && (n.localSearch.noResults = !1, t.ancestors.forEach((function (e) {
                            return n.localSearch.countMap[e.id][X]++
                        })), t.isLeaf && t.ancestors.forEach((function (e) {
                            return n.localSearch.countMap[e.id][Y]++
                        })), t.parentNode !== q && (n.localSearch.countMap[t.parentNode.id][K] += 1, t.isLeaf && (n.localSearch.countMap[t.parentNode.id][U] += 1))), (t.isMatched || t.isBranch && t.isExpandedOnSearch) && t.parentNode !== q && (t.parentNode.isExpandedOnSearch = !0, t.parentNode.hasMatchedDescendants = !0)
                    })), t()
                }, handleRemoteSearch: function () {
                    var t = this, n = this.trigger.searchQuery, i = this.getRemoteSearchEntry(), r = function () {
                        t.initialize(), t.resetHighlightedOptionWhenNecessary(!0)
                    };
                    if (("" === n || this.cacheOptions) && i.isLoaded) return r();
                    this.callLoadOptionsProp({
                        action: Z, args: {searchQuery: n}, isPending: function () {
                            return i.isLoading
                        }, start: function () {
                            i.isLoading = !0, i.isLoaded = !1, i.loadingError = ""
                        }, succeed: function (e) {
                            i.isLoaded = !0, i.options = e, t.trigger.searchQuery === n && r()
                        }, fail: function (e) {
                            i.loadingError = me(e)
                        }, end: function () {
                            i.isLoading = !1
                    ...
                    var e = this, t = this.trigger.searchQuery, n = this.remoteSearch[t] || w()({}, {
                        isLoaded: !1,
                        isLoading: !1,
                        loadingError: ""
                    }, {options: []});
                    ...
                    var l = this, e = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1],
                        t = this.menu.current;
                    if (null != t && t in this.forest.nodeMap && (this.forest.nodeMap[t].isHighlighted = !1), this.menu.current = a.id, a.isHighlighted = !0, this.menu.isOpen && e) {
                        var n = function () {
                            var e, t, n, i, r, o = l.getMenu(),
                                s = o.querySelector('.vue-treeselect__option[data-id="'.concat(a.id, '"]'));
                            s && (t = s, n = (e = o).getBoundingClientRect(), i = t.getBoundingClientRect(), r = t.offsetHeight / 3, i.bottom + r > n.bottom ? e.scrollTop = Math.min(t.offsetTop + t.clientHeight - e.offsetHeight + r, e.scrollHeight) : i.top - r < n.top && (e.scrollTop = Math.max(t.offsetTop - r, 0)))
                        };
                        this.getMenu() ? n() : this.$nextTick(n)
                    }
                }, resetHighlightedOptionWhenNecessary: function () {
                    var e = 0 < arguments.length && void 0 !== arguments[0] && arguments[0], t = this.menu.current;
                    ...
                    this.multiple && (this.traverseAllNodesByIndex((function (e) {
                        ...
                        i[e.id] = 2, t.flat || t.disableBranchNodes || e.ancestors.forEach((function (e) {
                    ...
                    var x = this, t = e.map((function (e) {
                        return [x.enhancedNormalizer(e), e]
                    })).map((function (e, t) {
                        var n = N()(e, 2), i = n[0], r = n[1];
                        x.checkDuplication(i), x.verifyNodeShape(i);
                        var o = i.id, s = i.label, a = i.children, l = i.isDefaultExpanded, u = O === q,
                            c = u ? 0 : O.level + 1, d = Array.isArray(a) || null === a, h = !d,
                            f = !!i.isDisabled || !x.flat && !u && O.isDisabled, p = !!i.isNew,
                            v = x.matchKeys.reduce((function (e, t) {
                                return w()({}, e, E()({}, t, (n = i[t], "string" == typeof n ? n : "number" != typeof n || C(n) ? "" : n + "").toLocaleLowerCase()));
                                var n
                        ...
                        if (x.$set(g, "id", o), x.$set(g, "label", s), x.$set(g, "level", c), x.$set(g, "ancestors", u ? [] : [O].concat(O.ancestors)), x.$set(g, "index", (u ? [] : O.index).concat(t)), x.$set(g, "parentNode", O), x.$set(g, "lowerCased", v), x.$set(g, "nestedSearchLabel", m), x.$set(g, "isDisabled", f), x.$set(g, "isNew", p), x.$set(g, "isMatched", !1), x.$set(g, "isHighlighted", !1), x.$set(g, "isBranch", d), x.$set(g, "isLeaf", h), x.$set(g, "isRootNode", u), x.$set(g, "raw", r), d) {
                            ...
                            x.$set(g, "childrenStates", w()({}, {
                                ...
                                isLoading: !1,
                                loadingError: ""
                            }, {isLoaded: S})), x.$set(g, "isExpanded", "boolean" == typeof l ? l : c < x.defaultExpandLevel), x.$set(g, "hasMatchedDescendants", !1), x.$set(g, "hasDisabledDescendants", !1), x.$set(g, "isExpandedOnSearch", !1), x.$set(g, "showAllChildrenOnSearch", !1), x.$set(g, "count", (y = {}, E()(y, K, 0), E()(y, X, 0), E()(y, U, 0), E()(y, Y, 0), y)), x.$set(g, "children", S ? x.normalize(g, a, _) : []), !0 === l && g.ancestors.forEach((function (e) {
                                e.isExpanded = !0
                            })), S || "function" == typeof x.loadOptions ? !S && g.isExpanded && x.loadChildrenOptions(g) : L((function () {
                                return !1
                            }), (function () {
                        ...
                        if (g.ancestors.forEach((function (e) {
                            return e.count[X]++
                        })), h && g.ancestors.forEach((function (e) {
                            return e.count[Y]++
                        })), u || (O.count[K] += 1, h && (O.count[U] += 1), f && (O.hasDisabledDescendants = !0)), _ && _[o]) {
                            var b = _[o];
                    ...
                    this.callLoadOptionsProp({
                        action: G, args: {parentNode: i}, isPending: function () {
                    ...
                    var t = this;
                    this.hasValue && (this.single || this.allowClearingDisabled ? this.forest.selectedNodeIds = [] : this.forest.selectedNodeIds = this.forest.selectedNodeIds.filter((function (e) {
                    ...
                    })), n) for (var i = e; (i = i.parentNode) !== q && i.children.every(this.isSelected);) this.addValue(i)
                    ...
                    if (e.isBranch && this.traverseDescendantsDFS(e, (function (e) {
                        ...
                        this.removeValue(e);
                        for (var i = e; (i = i.parentNode) !== q && this.isSelected(i);) this.removeValue(i)
                    }
                }, addValue: function (e) {
                    this.forest.selectedNodeIds.push(e.id), this.forest.selectedNodeMap[e.id] = !0
                }, removeValue: function (e) {
                    m(this.forest.selectedNodeIds, e.id), delete this.forest.selectedNodeMap[e.id]
            ...
            mounted: function () {
                (this.autoFocus || this.autofocus) && this.focusInput(), this.options || this.async || !this.autoLoadRootOptions || this.loadRootOptions(), this.alwaysOpen && this.openMenu(), this.async && this.defaultOptions && this.handleRemoteSearch()
            },
            destroyed: function () {
        ...
        function Se(e) {
            return "string" == typeof e ? e : null == e || C(e) ? "" : JSON.stringify(e)
        }
        ...
        var Oe = be({
            ...
            functional: !0,
            render: function (e, t) {
                var n = e, i = t.injections.instance;
        ...
        var _e = Oe.exports, xe = n(2), Ne = n.n(xe), Ee = [oe, ae, le, ue, ce, de, he], we = be({
            name: "vue-treeselect--input", inject: ["instance"], data: function () {
                ...
                this.debouncedCallback = p()(this.updateSearchQuery, 200, {leading: !0, trailing: !0})
            }, methods: {
                clear: function () {
                    ...
                    var e = this.instance;
                    if (document.activeElement === e.$refs.menu) return this.focus();
                    e.trigger.isFocused = !1, e.closeMenu()
                }, onInput: function (e) {
                    var t = e.target.value;
                    (this.value = t) ? this.debouncedCallback() : (this.debouncedCallback.cancel(), this.updateSearchQuery())
                }, onKeyDown: function (e) {
                    var t = this.instance, n = "which" in e ? e.which : e.keyCode;
                    if (!(e.ctrlKey || e.shiftKey || e.altKey || e.metaKey)) {
                        if (!t.menu.isOpen && P(Ee, n)) return e.preventDefault(), t.openMenu();
                        switch (n) {
                            case re:
                    ...
                    }), t.searchable || t.disabled || F(n, {attrs: {tabIndex: t.tabIndex}}), e("div", Ne()([{class: "vue-treeselect__input-container"}, n]), [i])
        ...
        var Me = Ce.exports, Ie = be({
            ...
            render: function () {
                var e = arguments[0], t = this.instance;
                return (0, this.$parent.renderValueContainer)([t.hasValue && !t.trigger.searchQuery && e("div", {class: "vue-treeselect__single-value"}, [this.renderSingleValueLabel()]), e(Me), e(Le, {ref: "input"})])
            }
        }, void 0, void 0, !1, null, null, null);
        Ie.options.__file = "SingleValue.vue";
        var De = Ie.exports, Te = be({name: "vue-treeselect--x"}, (function () {
        ...
        var $e = Te.exports, Ae = be({
            ...
            render: function () {
                ...
                }, [e("span", {class: "vue-treeselect__multi-value-label"}, [o]), e("span", {class: "vue-treeselect__icon vue-treeselect__value-remove"}, [e($e)])])])
            }
        }, void 0, void 0, !1, null, null, null);
        Ae.options.__file = "MultiValueItem.vue";
        var Be = Ae.exports, Re = be({
            name: "vue-treeselect--multi-value",
            inject: ["instance"],
            methods: {
                renderMultiValueItems: function () {
                    var t = this.$createElement, e = this.instance;
                    return e.internalValue.slice(0, e.limit).map(e.getNode).map((function (e) {
                        return t(Be, {key: "multi-value-item-".concat(e.id), attrs: {node: e}})
                    }))
            ...
            render: function () {
                var e = arguments[0];
                return (0, this.$parent.renderValueContainer)(e("transition-group", Ne()([{class: "vue-treeselect__multi-value"}, {
                    props: {
                        tag: "div",
                        name: "vue-treeselect__multi-value-item--transition",
                        appear: !0
                    }
                }]), [this.renderMultiValueItems(), this.renderExceedLimitTip(), e(Me, {key: "placeholder"}), e(Le, {
                    ref: "input",
                    key: "input"
                })]))
            }
        ...
        var ze = Re.exports, Ve = be({name: "vue-treeselect--arrow"}, (function () {
            var e = this.$createElement, t = this._self._c || e;
            return t("svg", {
                attrs: {
                    xmlns: "http://www.w3.org/2000/svg",
        ...
        var ke = Ve.exports, Fe = be({
            name: "vue-treeselect--control", inject: ["instance"], computed: {
                shouldShowX: function () {
                    ...
                    var t = this.instance;
                    return t.hasValue && t.internalValue.some((function (e) {
                        return !t.getNode(e).isDisabled
                    }))
                }
            }, methods: {
                renderX: function () {
                    ...
                    }, [e($e, {class: "vue-treeselect__x"})]) : null
                    ...
                    M()(n) ? n.then(i) : setTimeout((function () {
                        return i(n)
                    }), 0)
                ...
                var e = arguments[0], t = this.instance, n = t.single ? De : ze;
                return e("div", {
        ...
        var Pe, We, Qe, qe = He.exports, Ke = {
            ...
            methods: {
                renderOption: function () {
                    ...
                    return t.hasBranchNodes ? (Pe || (Pe = e("div", {class: "vue-treeselect__option-arrow-placeholder"}, [" "])), Pe) : null
                    ...
                    return We || (We = e("span", {class: "vue-treeselect__check-mark"})), Qe || (Qe = e("span", {class: "vue-treeselect__minus-mark"})), e("span", {class: r}, [We, Qe])
                    ...
                    var e = this.$createElement, t = this.instance, n = this.node,
                        ...
                        o = "vue-treeselect__label", s = "vue-treeselect__count", a = t.$scopedSlots["option-label"];
                    return a ? a({
                        node: n,
                        shouldShowCount: i,
                        count: r,
                        labelClassName: o,
                        countClassName: s
                    }) : e("label", {class: o}, [n.label, i && e("span", {class: s}, ["(", r, ")"])])
                }, renderSubOptions: function () {
                    var t = this.$createElement, e = this.node;
                    return e.childrenStates.isLoaded ? e.children.map((function (e) {
                        return t(Ke, {attrs: {node: e}, key: e.id})
                    })) : null
                }, renderNoChildrenTip: function () {
                    var e = this.$createElement, t = this.instance, n = this.node;
                    return !n.childrenStates.isLoaded || n.children.length ? null : e(qe, {
                        attrs: {
                            type: "no-children",
                            icon: "warning"
                        }
                    ...
                    var e = this.$createElement, t = this.instance;
                    return this.node.childrenStates.isLoading ? e(qe, {
                        attrs: {
                            type: "loading",
                            icon: "loader"
                        }
                    ...
                    var e = this.$createElement, t = this.instance, n = this.node;
                    return n.childrenStates.loadingError ? e(qe, {
                        attrs: {
                            type: "error",
                            icon: "error"
                        }
        ...
        var Ue = Xe.exports, Ye = {top: "top", bottom: "bottom", above: "top", below: "bottom"}, Je = be({
            name: "vue-treeselect--menu", inject: ["instance"], computed: {
                ...
                renderMenu: function () {
                    ...
                    }, [t.async ? this.renderAsyncSearchMenuInner() : t.localSearch.active ? this.renderLocalSearchMenuInner() : this.renderNormalMenuInner()]) : null
                    ...
                    var t = this.$createElement, e = this.instance;
                    return t("div", {class: "vue-treeselect__list"}, [e.forest.normalizedOptions.map((function (e) {
                        return t(Ue, {attrs: {node: e}, key: e.id})
                    }))])
                }, renderSearchPromptTip: function () {
                    var e = this.$createElement, t = this.instance;
                    return e(qe, {attrs: {type: "search-prompt", icon: "warning"}}, [t.searchPromptText])
                }, renderLoadingOptionsTip: function () {
                    var e = this.$createElement, t = this.instance;
                    return e(qe, {attrs: {type: "loading", icon: "loader"}}, [t.loadingText])
                    ...
                    var e = this.$createElement, t = this.instance;
                    return e(qe, {attrs: {type: "no-options", icon: "warning"}}, [t.noOptionsText])
                }, renderNoResultsTip: function () {
                    var e = this.$createElement, t = this.instance;
                    return e(qe, {attrs: {type: "no-results", icon: "warning"}}, [t.noResultsText])
                }, onMenuOpen: function () {
                    ...
                    if (e.menu.isOpen) {
                        var t = e.getMenu(), n = e.getControl(), i = t.getBoundingClientRect(),
                            ...
                            l = o + 40 < window.innerHeight - r.bottom, u = o + 40 < a;
                        0 <= r.top && r.top <= s || r.top < 0 && 0 < r.bottom ? "auto" !== e.openDirection ? e.menu.placement = Ye[e.openDirection] : e.menu.placement = l || !u ? "bottom" : "top" : e.closeMenu()
                    }
                }, setupMenuSizeWatcher: function () {
                    var e = this.instance.getMenu();
                    this.menuSizeWatcher || (this.menuSizeWatcher = {remove: O(e, this.adjustMenuOpenDirection)})
                }, setupMenuResizeAndScrollEventListeners: function () {
                    var e = this.instance.getControl();
                    this.menuResizeAndScrollEventListeners || (this.menuResizeAndScrollEventListeners = {remove: _(e, this.adjustMenuOpenDirection)})
        ...
        var Ge, Ze = Je.exports, et = n(18), tt = n.n(et), nt = {
            ...
            methods: {
                setupHandlers: function () {
                    ...
                    var e = this.instance.getControl();
                    this.controlResizeAndScrollEventListeners || (this.controlResizeAndScrollEventListeners = {remove: _(e, this.updateMenuContainerOffset)})
            ...
            name: "vue-treeselect--menu-portal", created: function () {
                ...
                setup: function () {
                    ...
                    document.body.appendChild(e), this.portalTarget = new tt.a(w()({el: e, parent: this}, nt))
                }, teardown: function () {
                ...
                var e = arguments[0];
                return Ge || (Ge = e("div", {class: "vue-treeselect__menu-placeholder"})), Ge
            }
        }, void 0, void 0, !1, null, null, null);
        it.options.__file = "MenuPortal.vue";
        var rt = it.exports, ot = be({
            name: "vue-treeselect", mixins: [ye], computed: {
                ...
                }, [e(_e), e(je, {ref: "control"}), this.appendToBody ? e(rt, {ref: "portal"}) : e(Ze, {ref: "menu"})])
            }
        }, void 0, void 0, !1, null, null, null);
